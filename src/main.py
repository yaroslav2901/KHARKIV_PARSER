...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Kharkiv Oblenergo parser")
...
def main():
    ...
    if args.parse:
        ...
        try:
            result = asyncio.run(kharkiv_telegram_parser.main())
